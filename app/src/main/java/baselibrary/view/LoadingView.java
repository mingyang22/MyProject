...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.LoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, DisplayUtils.dip2px(context, 32));
        mPaintColor = array.getInt(R.styleable.LoadingView_color, Color.WHITE);
        array.recycle();
        initPaint();
