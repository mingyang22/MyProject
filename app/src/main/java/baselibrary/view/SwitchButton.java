...
public class SwitchButton extends android.support.v7.widget.AppCompatCheckBox {
     ...
     * 开关选中状态,即打开状态时的背景颜色
     */
    private int mBackgroundColorChecked = 0xFF0E6DCF;
    /**
     * 开关指示器按钮的颜色
     */
...
//            x = radius + mPaint.getStrokeWidth() + mPaint.getStrokeWidth();
    ...
    /**
     * 获取一个过渡期中当前颜色,fraction 为过渡系数,取值范围 0f-1f,值越接近 1,颜色就越接近 endColor
     *
